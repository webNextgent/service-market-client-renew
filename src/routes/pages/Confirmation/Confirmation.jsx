...
export default function Confirmation() {
    ...
    const subTotalWithCOD = paymentMethod === "Cash" ? Number(subTotal) + cashOnDeliveryCharge : Number(subTotal);
    const vatAmount = (subTotalWithCOD * 0.05).toFixed(2);
    const discountAmount = useDiscount > 0 ? (subTotalWithCOD * useDiscount) / 100 : 0;
    const finalTotal = paymentMethod === "Cash" ? (totalAfterDiscount + cashOnDeliveryCharge).toFixed(2) : totalAfterDiscount.toFixed(2);
